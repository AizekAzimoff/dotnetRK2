        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    stud_phone = table.Column<string>(nullable: true),
                    stud_mail = table.Column<string>(nullable: true),
                    GroupID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Groups",
                columns: new[] { "GroupID", "group_level", "group_name", "group_stud_num" },
                values: new object[] { -1, "Advanced", "English1602", 10 });
